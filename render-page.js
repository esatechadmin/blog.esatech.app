...
var plugins=[{plugin:__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '/data/projects/esatech/blog/plugins/gatsby-plugin-ghost-manifest/gatsby-ssr'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),options:{"plugins":[],"short_name":"Ghost","start_url":"/","background_color":"#e9e9e9","theme_color":"#15171A","display":"minimal-ui","icon":"static/favicon.png","legacy":true,"query":"\n                {\n                    allGhostSettings {\n                        edges {\n                            node {\n                                title\n                                description\n                            }\n                        }\n                    }\n                }\n              "}},{plugin:__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '/data/projects/esatech/blog/node_modules/gatsby-plugin-feed/gatsby-ssr'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),options:{"plugins":[],"query":"\n                {\n                    allGhostSettings {\n                        edges {\n                            node {\n                                title\n                                description\n                            }\n                        }\n                    }\n                }\n              ","feeds":[{"query":"\n        {\n            allGhostPost(\n                sort: {order: DESC, fields: published_at}\n            ) {\n                edges {\n                    node {\n                        # Main fields\n                        id\n                        title\n                        slug\n                        featured\n                        feature_image\n\n                        # Dates unformatted\n                        created_at\n                        published_at\n                        updated_at\n\n                        # SEO\n                        excerpt\n                        meta_title\n                        meta_description\n\n                        # Authors\n                        authors {\n                            name\n                        }\n                        primary_author {\n                            name\n                        }\n                        tags {\n                            name\n                            visibility\n                        }\n\n                        # Content\n                        html\n\n                        # Additional fields\n                        url\n                        canonical_url\n                    }\n                }\n            }\n        }\n  ","output":"/rss"}]}},{plugin:__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '/data/projects/esatech/blog/node_modules/gatsby-plugin-advanced-sitemap/gatsby-ssr'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),options:{"plugins":[],"query":"\n                {\n                    allGhostPost {\n                        edges {\n                            node {\n                                id\n                                slug\n                                updated_at\n                                created_at\n                                feature_image\n                            }\n                        }\n                    }\n                    allGhostPage {\n                        edges {\n                            node {\n                                id\n                                slug\n                                updated_at\n                                created_at\n                                feature_image\n                            }\n                        }\n                    }\n                    allGhostTag {\n                        edges {\n                            node {\n                                id\n                                slug\n                                feature_image\n                            }\n                        }\n                    }\n                    allGhostAuthor {\n                        edges {\n                            node {\n                                id\n                                slug\n                                profile_image\n                            }\n                        }\n                    }\n                }","mapping":{"allGhostPost":{"sitemap":"posts"},"allGhostTag":{"sitemap":"tags"},"allGhostAuthor":{"sitemap":"authors"},"allGhostPage":{"sitemap":"pages"}},"exclude":["/dev-404-page","/404","/404.html","/offline-plugin-app-shell-fallback"],"createLinkInHead":true,"addUncaughtPages":true}},{plugin:__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '/data/projects/esatech/blog/node_modules/gatsby-plugin-react-helmet/gatsby-ssr'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),options:{"plugins":[]}},{plugin:__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '/data/projects/esatech/blog/node_modules/gatsby-plugin-offline/gatsby-ssr'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),options:{"plugins":[]}}];// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
